const album1 = {
  ...
  const newKeyName = 'date';
  album3.albumDetails[newKeyName] = album3.albumDetails.released;
  delete album3.albumDetails.released;
...
console.log(formats)
  ...
  talkingHeadsAlbums[4] = album5.albumDetails.labels
